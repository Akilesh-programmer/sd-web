    ...
    <div className="bg-primary-800 text-white py-2 hidden md:block">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center text-sm">
          ...
          {/* Social Links & E-Brochure */}
          <div className="flex items-center space-x-4">
            <a
              href={COMPANY_INFO.contact.brochure}
              className="flex items-center space-x-2 bg-secondary-500 hover:bg-secondary-600 px-3 py-1 rounded transition-colors"
              download
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path
            ...
            <div className="flex items-center space-x-3 border-l border-primary-600 pl-4">
              <a
